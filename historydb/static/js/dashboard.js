...
function UpdateConfigurationsList(machine_configurations_avail, software_configurations_avail, outputs_avail, user_configurations_avail) {
    ...
    if (tuning_problem_unique_name in machine_configurations_avail) {
    ...
    if (tuning_problem_unique_name in software_configurations_avail) {
    ...
    if (tuning_problem_unique_name in outputs_avail) {
    ...
    if (tuning_problem_unique_name in user_configurations_avail) {
